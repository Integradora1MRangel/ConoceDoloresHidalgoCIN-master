...
public class RouteDhActivity extends AppCompatActivity {
    ...
    public RouteActivity[] routes = {
            new RouteActivity(mx.utng.edu.conoceDolores.R.drawable.ic_church, "Ruta independencia", "Conoce los lugares más importantes para la independencia del municipio"),
            new RouteActivity(mx.utng.edu.conoceDolores.R.drawable.ic_film, "Ruta Jose Alfredo", "Descubre los bares  donde el cantante y compositor mexicano creó una gran cantidad de temas, principalmente rancheras, huapangos y corridos"),
